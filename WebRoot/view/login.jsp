...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<form id="loginForm" action="/ms/toLogin.do" method="post">
					...
					<ul>
							...
							<div class=user_main_box>
								...
								<ul>
									...
									<li class=user_main_input>
										...
										<input class="vc-text easyui-validatebox" data-options="missingMessage:'验证码不能为空.'" maxlength="4" type="text" name="verifyCode">
										<!-- required:true, -->
									</li>
								</ul>
							</div>
						...
						<li class=user_main_r>
							<input class="ibtnentercssclass"
								...
								type=image src="${msUrl}/images/login/user_botton.gif">
						</li>
					</ul>
				<dd id=user_bottom>
					<ul>
